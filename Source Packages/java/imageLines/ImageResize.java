...
public class ImageResize extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         //System.out.println("Getting image through image resize at "+dateFormat.format(date));
            ...
            try {
               ...
               if (toResize != null) {
                  LOG.log(Level.INFO, "Loaded image {0} from cache", folioNum);
                   ...
                   Date date4 = new Date();
                   //System.out.println("Begin loading image from source at "+dateFormat.format(date4));
                  ...
                  try (InputStream stream = f.getUncachedImageStream(false)) {
                     ...
                     stream.close();
                     Date date5 = new Date();
                    //System.out.println("Got image from source at "+dateFormat.format(date5));
						}
               }
               ...
               Date date3 = new Date();
               //System.out.println("Return image from image resize at "+dateFormat.format(date3));
