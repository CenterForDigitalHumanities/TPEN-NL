...
/**Return the value for this key as an integer*/
    ...
    public String javascriptToAddProjectButtonsRawData(int projectID) throws SQLException {
        ...
        try {
            ...
            /* Hotkeys that should be available for ALL PROJECTS go here */
//            jo.element("uid", uid);
//            
//            //eacute
//            jo.element("key", 233);
...
//            //ograve
//             jo.element("key", 242);
//            jo.element("position", 5);
//            ja.add(jo);
//            
//            //ugrave
//            jo.element("key", 249);
//            jo.element("position", 6);
//            ja.add(jo);
//            
//            //Egrave
//             jo.element("key", 200);
//            jo.element("position", 7);
//            ja.add(jo);
//            
//            //Agrave
//             jo.element("key", 192);
//            jo.element("position", 8);
//            ja.add(jo);
//            
//            //Ograve
//            jo.element("key", 210);
//            jo.element("position", 9);
//            ja.add(jo);
            while (rs.next()) {
                ctr++;
    ...
    public void delete() throws SQLException {
        if (this.projectID > 0) {
            ...
            try {
                ...
                //This depends on the position being in sequence, which is not guranteed.  It is screwing up deleting, must rewrite
