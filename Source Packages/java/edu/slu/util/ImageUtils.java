...
public class ImageUtils {
   ...
   public static Dimension getJPEGDimension(InputStream input) throws IOException {
      // Check for SOI marker.
        ...
        Date date = new Date();
        //System.out.println("Image Utils getJPEGDimension() at "+dateFormat.format(date));
      ...
      while (input.read() == 255) {
         ...
         if (marker == 192) {
            ...
            Date date2 = new Date();
            //System.out.println("Return Image Utils getJPEGDimension() at "+dateFormat.format(date2));
