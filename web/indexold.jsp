...
//    }
    %>
              ...
              notation" />
                                                                    ...
                                                                    <title>T&#8209;PEN
                                                                        <%out.println("Version " + Folio.getRbTok("VERSION"));%>
                                                                    </title>
                                                                    ...
                                                                    <style type="text/css">
                                                                        ...
                                                                        body {
                                                                            background: #69ACC9 url(images/tpen_logo_header.jpg) top left no-repeat scroll;
                                                                        }
                                                                        ...
                                                                        #userUnknown2 a,
                                                                        #userUnknown2 input[type="submit"] {
                                                                            margin: 3px 0;
                                                                            width: 150px;
                                                                        }
                                                                    ...
                                                                    <script type="text/javascript">
                                                                                ...
                                                                                click: function() {
                                                                                    ...
                                                                                    $("#browseMS,#overlay").show('fade', 500, function() {
                                                                                        if ($this.parent().parent().is("#cityMS")) {
                                                                                            ...
                                                                                            alert("Apologies, but there was an error with your request.")
                                                                                        }
                                                                                    });
                                                                                }
                                                                            });
                                                                        ...
                                                                        if (!Date.prototype.format) {
                                                                            Date.prototype.format = (function() {
                                                                                var a = {
                                                                                    d: function() {
                                                                                        var b = this.getDate().toString();
                                                                                        return b.length === 1 ? "0" + b : b
                                                                                    },
                                                                                    D: function() {
                                                                                        return a.l.call(this).slice(0, 3)
                                                                                    },
                                                                                    j: function() {
                                                                                        return this.getDate()
                                                                                    },
                                                                                    ...
                                                                                    W: function() {
                                                                                        ...
                                                                                        return Math.ceil((((this - b) / 86400000) + b.getDay() + 1) / 7)
                                                                                    },
                                                                                    F: function() {
                                                                                    ...
                                                                                    M: function() {
                                                                                        return a.F.call(this).slice(0, 3)
                                                                                    },
                                                                                    n: function() {
                                                                                    ...
                                                                                    O: function() {
                                                                                        var b = this.getTimezoneOffset() / 60;
                                                                                        return (b < 0 ? "" : "+") + (b < 10 ? "0" + b.toString() : b.toString()) + "00"
                                                                                    },
                                                                                    P: function() {
                                                                                        var b = a.O.call(this);
                                                                                        return b.slice(0, 3) + ":" + b.slice(-2)
                                                                                    },
                                                                                    T: function() {
                                                                                        return null
                                                                                    },
                                                                                    Z: function() {
                                                                                        return parseInt(a.O.call(this), 10) * 60
                                                                                    },
                                                                                    c: function() {
                                                                                        function c(d) {
                                                                                        ...
                                                                                        var b = "";
                                                                                        b += this.getUTCFullYear() + "-";
                                                                                        b += c(this.getUTCMonth() + 1) + "-";
                                                                                        b += c(this.getUTCDate()) + "T";
                                                                                        b += c(this.getUTCHours()) + ":";
                                                                                        b += c(this.getUTCMinutes()) + ":";
                                                                                        b += c(this.getUTCSeconds()) + "Z";
                                                                                        return b
                                                                                    },
                                                                                    r: function() {
    ...
    if (thisUser == null){%>
                                                                            ...
                                                                            <%}%>
                                                                                ...
                                                                                <div id="header2">
                                                                                    <div id="maintenance" class="loud">
                                                                                        <span class="ui-icon ui-icon-info left"></span> Scheduled Maintenance: <span id="schedmaintenance"></span>
                   ...
                   //     int sbLength = usersTranscribing.length();
                    ...
                    %>
                                                                                        ...
                                                                                        <div>
                                                                                            Welcome,
                                                                                            <%out.print(thisUser.getFname()+" "+thisUser.getLname());%>. <a href="login.jsp" onclick="logout();return false;">Logout/Change User</a>
                                                                                                <br/>
                   ...
                   %>
                                                                                        ...
                                                                                        <div id="advancedTpen" class="lists ui-tabs-panel ui-widget-content ui-corner-bottom" style="">
                                                                                            ...
                                                                                            <p class="gloss ui-state-active ui-corner-all left">
                                                                                                T‑PEN includes several advanced features that allow a user to accomplish even more. As they are available, these options will be listed here. These useful tools are in good working order, but may require technical knowledge or preparation to use.</p>
                                                                                            <div class="clear-left">
                                                                                                <h3>Private Collections</h3>
                                                                                                <p>
                                                                                                    Private collections of images can be hosted by T‑PEN, analyzed by our tools, and transcribed as if loaded from a repository.
                                                                                                </p>
                                                                                                <p>
                                                                                                ...
                                                                                                <div id="uploadImages" class="ui-widget-content ui-corner-all">
                                                                                                    ...
                                                                                                    <p>
                                                                                                        T‑PEN will store private user images for you. Properly prepared files will be imported into a project to which you can invite
                                                                                                        <span class="loud">up to 5 collaborators</span>. Uploaded images do not appear in manuscript listings, cannot be publicly shared, and cannot be included
                                                                                                        ...
                                                                                                        <ol class="left">
                                                                                                            ...
                                                                                                            <li>Combine all images into a single <strong>.zip file</strong>;
                                                                                                                <ul>
                                                                                                                    ...
                                                                                                                    <li>this filename will be used in your project title, but may be changed.</li>
                                                                                                                </ul>
                                                                                                            </li>
                                                                                                        ...
                                                                                                        <form id="fileUpload" onsubmit="if(setAction())ajaxFunction();" action="FileUpload?city=private&amp;repository=lib&amp;collection=TPEN(private)" enctype="multipart/form-data" method="POST" target="upload-frame" class="clear">
                                                                                                            ...
                                                                                                            <div id="fileUploadSubmit">
                                                                                                                <div id="creatingProject">
                                                                                                                    ...
                                                                                                                    <div class="quiet">
                                                                                                                        This may take several minutes for large files.<br> You may leave this page while T‑PEN works.
                                                                                                                    </div>
                                                                                                                </div>
                        ...
                        Upload another file
                                                                                                            ...
                                                                                                            <div id="progressbarWrapper" style="width:100%;display: none;">
                                                                                                                <div id="progressbar" style="height:24px;" class="ui-progressbar ui-widget ui-widget-content ui-corner-all" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
                                                                                            ...
                                                                                            <div>
                                                                                                ...
                                                                                                <p>
                                                                                                    Any project that does not contain any private images can become a Public Project, allowing users who are not members access to all or part of the project. The permissions of any project can be changed at any time by the group leader.
                                                                                                </p>
                                                                                                <p>
                                                                                                    View all Public Projects on the tab above. Set permissions for your eligible project by using the "Share Publicly" button at the top of the "Collaboration" tab on the
                                                                                            ...
                                                                                            <div id="projects">
                                                                                                ...
                                                                                                <div class="lists">
                                                                                                    <div id="welcome" class="column">
                                                                                                        ...
                                                                                                        <p>T&#8209;PEN is a web-based tool for working with images of manuscripts. Users attach transcription data (new or uploaded) to the actual lines of the
                                                                                                            original manuscript in a simple, flexible interface. </p>
                                                                                                        ...
                                                                                                        <ul>T&#8209;PEN...
                                                                                                            ...
                                                                                                            <li>Allows transcriptions to be <span class="loud" title="Use an expanding set of tools or load your own">created, manipulated, and viewed</span> in
                                                                                                                many ways</li>
                                                                                                            ...
                                                                                                            <li><span class="loud" title="Take your data with you or let us serve it up as needed">Exports</span> transcriptions as a pdf, XML(plaintext) for further
                                                                                                                processing, or contribute to a collaborating institution with a click</li>
                                                                                                            <li>Respects <span class="loud" title="A simple data structure allows for exchange without a hassle">existing and emerging standards</span> for text,
                                                                                                                image, and annotation data storage</li>
                ...
                %>
                                                                    ...
                                                                    <div id="browseMS">
                                                                        <!-- container for browsing listings -->
                                                                        <div class="callup" id="browseMSPanel">
                                                                            <!-- select -->
