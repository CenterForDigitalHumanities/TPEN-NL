...
%>
    ...
    "http://www.w3.org/TR/html4/loose.dtd">
                ...
                input.colors:focus {color:black !important;background: white none !important;width:84px !important;}*/
                                            ...
                                            /* TODO show when colors are supported */
                                                                    ...
                                                                    <script type="text/javascript">
                                                                        $(function() {
                                                                            ...
                                                                            $(".xmlPanel").focusin(function() {
                                                                                $(".xmlPanel").not(this).each(function() {
                                                                                    collapsePanel(this);
                                                                                });
                                                                                expandPanel(this);
                                                                            });
            ...
            %>
                                                                ...
                                                                <div id="tabs-2">
                                                                    <div class="right" style="width:440px;">
                                                                        ...
                                                                        <p>Rearrange by clicking on the blue box and dragging. Click the "X" icon to remove a button from the list. Add as many buttons as is useful. You will access them through the footer
                                                                            menu.</p>
                                                                    </div>
