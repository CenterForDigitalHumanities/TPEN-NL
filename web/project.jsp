...
%>
                                                ...
                                                <head>
                                                    ...
                                                    <style type="text/css">
                                                        ...
                                                        #project div.tall li:last-child {
                                                            bottom: -13px;
                                                            min-height: 80px;
                                                        }
                                                        ...
                                                        #currentSetting:before {
                                                            content: 'Currently set to: "';
                                                            color: black;
                                                            font-weight: normal;
                                                        }
                                                        
                                                        #currentSetting:after {
                                                            content: '"';
                                                            color: black;
                                                            font-weight: normal;
                                                        }
                                                        ...
                                                        #exportLinebreakString,
                                                        #exportWordbreak {
                                                            width: 40px;
                                                        }
                                                        
                                                        #quickExport span.choices {
                                                            width: 32%;
                                                            float: left;
                                                            position: relative;
                                                            padding: 15px 0;
        ...
        %>
                                                                            <script>
                                                                                $(function() {
                                                                                    $('#inviteFeedback').html('<span class=\"ui-state-highlight ui-corner-all\"><%out.print(request.getParameter("email"));%> has been invited to the project.<span>');
                                                                                });
        ...
        %>
                                                                                <script>
                                                                                    $(function() {
                                                                                        $('#inviteFeedback').html('<span class=\"ui-state-error ui-corner-all\"><%out.print(request.getParameter("email"));%> has been invited to join, but only the project leader may add someone to a project.<span>');
...
%>
                                                                                    <script>
                                                                                        $(function() {
                                                                                            $('#inviteFeedback').html('<span class=\"ui-state-error ui-corner-all\">An account with that email address exists already. Please use the "Add to Project" option to include them on your team. If you have any further trouble, please contact us.<span>');
                                                                                            $('#inviteFeedback').effect('pulsate', 500);
                                                                                        });
        ...
        %>
                                                                                        <script>
                                                                                            $(function() {
                                                                                                $('#inviteFeedback').html('<span class=\"ui-state-error ui-corner-all\"><%out.print(request.getParameter("fname"));%> was successfully invited, but an e-mail error occurred. Please contact TPEN.<span>');
                                                                                                $('#inviteFeedback').effect('pulsate', 500);
                                                                                            });
        ...
        %>
                                                                                            <script>
                                                                                                $(function() {
                                                                                                    $('#inviteFeedback').html('<span class=\"ui-state-error ui-corner-all\"><%out.print(request.getParameter("fname"));%> was successfully invited, but an e-mail error occurred. Please contact TPEN. To add <%out.print(request.getParameter("fname"));%> to this project, the request must be made by the project leader.<span>');
                                                                                                    $('#inviteFeedback').effect('pulsate', 500);
                                                                                                });
        ...
        %>
                    ...
                    out.print("=" + request.getParameter("selecTab"));
                                ...
                                if (!isMember){
                                %>
                                                                                <p class="ui-state-highlight">You are viewing public project, <span class="loud bold"><%out.print(ESAPI.encoder().decodeFromURL(thisProject.getProjectName()));%></span>. To manage one of your own projects,
                                                                                    click below.</p>
                                                                                <%} else {%>
                                                                                    <p>
                                                                                        Active project is &nbsp;<span class="loud"><%out.print(ESAPI.encoder().decodeFromURL(thisProject.getProjectName()));%></span>.<br> Active Project T&#8209;PEN I.D.&nbsp;&nbsp;
                                                                                        <span
                                                                                            class="loud">
                                                                                            <%out.print((thisProject.getProjectID()));%>
                                                                                                </span>
                                                                                    </p>
...
%>
                                                                                    <p class="metadataInfo">
                                                                                        ...
                                                                                        <%out.print(m.getTitle());%><br />
                                                                                            <span class="label">Subtitle: </span>
                                                                                            <%out.print(m.getSubtitle());%><br />
                                                                                                <span class="label">MS&nbsp;Identifier: </span>
                                                                                                <%out.print(m.getMsIdentifier());%><br />
                                                                                                    <span class="label">MS&nbsp;Settlement: </span>
                                                                                                    <%out.print(m.getMsSettlement());%><br />
                                                                                                        <span class="label">MS&nbsp;Repository: </span>
                                                                                                        <%out.print(m.getMsRepository());%><br />
                                                                                                            <span class="label">MS&nbsp;Collection: </span>
                                                                                                            <%out.print(m.getMsCollection());%><br />
                                                                                                                <span class="label">MS&nbsp;ID&nbsp;number: </span>
                                                                                                                <%out.print(m.getMsIdNumber());%><br />
                                        ...
                                        for (int i = 0; i < leader.length; i++) {
                                            ...
                                            out.print(leader[i].getFname() + " " + leader[i].getLname());
                                                                                                                        ...
                                                                                                                        <%out.print(m.getSubject());%>
                                                                                                                            ...
                                                                                                                            <%out.print(m.getAuthor());%>
                                                                                                                                <span class="label">Date: </span>
                                                                                                                                <%out.print(m.getDate());%>
                                                                                                                                    <span class="label">Location: </span>
                                                                                                                                    <%out.print(m.getLocation());%>
                                                                                                                                        <span class="label">Language: </span>
                                                                                                                                        <%out.print(m.getLanguage());%>
                                                                                    </p>
                                                                                    <%if(permitMetadata || isMember){%>
                                        ...
                                        <option SELECTED>Jump to page</option>
                                                                            ...
                                                                            <%if(permitModify || isMember){%>
                                                                                <li class="left ui-widget-content ui-corner-tr ui-corner-bl"><a class="tpenButton" href="projSequence.jsp?projectID=<%out.print(" " + projectID);%>"><span class="ui-icon ui-icon-image right"></span>Modify image sequence</a>
                                                                                    <p>Change the order of or remove pages within this project.</p>
                                                                                </li>
                                                                                <%}%>
                                                                        </div>
                                                                    </ul>
...
<%}%>
                           ...
                           %>
                                                                                                        <div class="hideWhileCopying">
                                                                                                            ...
                                                                                                            <p>Create a new project with the same set of images and buttons. This copy will not include any transcription data, just project data. Once copied,
                                                                                                                the projects will not synchronize cannot be recombined in T&#8209;PEN.</p><br>
                                                                                                            ...
                                                                                                            <p>Create a new project with the same set of images, transcriptions, and buttons. Once copied, the projects will not synchronize cannot be recombined
                                                                                                                in T&#8209;PEN.</p>
                                                                                                        </div>
                                                                                                        <%}%>
                                                    ...
                                                    <%@include file="WEB-INF/includes/projectTitle.jspf" %>
                                                        <script type="text/javascript">
                                                            $(function() {
                                                                ...
                                                                $("#export").find("button").hover(function() {
                                                                ...
                                                                $(".publicLabel").children('input').on('change', function() {
                                                                    $("#publicOptionResult").fadeOut('slow');
                                                                });
                                                            ...
                                                            function addTool() {
                                                                ...
                                                                if (name.length < 1) {
                                                                    $("#addToolName").addClass('ui-state-error').one('change', function() {
                                                                        $(this).removeClass('ui-state-error')
                                                                    });
                                                                    return false;
                                                                }
                                                                if (URL.length < 5) {
                                                                    $("#addToolURL").addClass('ui-state-error').one('change', function() {
                                                                        $(this).removeClass('ui-state-error')
                                                                    });
                                                                    return false;
                                                                }
                                                                var newTool = ['<label class="projectTools"><input name="projectTool[]" type="checkbox" checked="true" value="',
                                                                    URL, '" title="', name, '"><span contenteditable="true">', name, '</span></label>'
                                                                ].join('');
    ...
    %>
                                                        <script>
                                                            $("#xmlImportDiv").prepend("<span class='ui-icon ui-icon-alert left'></span>Failed to import. Please check the link and try again. For more information on compatable file formats, check the wiki documentation.");
                                                            $("#xmlImportDiv").addClass("ui-corner-all ui-state-error");
                                                        </script>
                                                        <%                }
        }
    %>
