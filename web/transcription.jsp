...
%>
    ...
    "http://www.w3.org/TR/html4/strict.dtd">
        ...
        %>
                                                                                    ...
                                                                                    <link href="https://fonts.googleapis.com/css?family=Nova+Cut:regular&v1" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="jwysiwyg/jquery.wysiwyg.js"></script>        -->
                                                                                    ...
                                                                                    <style type="text/css">
                                                                                        ...
                                                                                        #workspace {
                                                                                            ...
                                                                                            background: -moz-linear-gradient(top, rgba(0, 0, 0, 1) 0%, rgba(255, 255, 255, 0.4) 10%, rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.4) 90%, rgba(0, 0, 0, 1) 100%), url(images/linen.png);
                                                                                            /* FF3.6+ */
                                                                                            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(0, 0, 0, 1)), color-stop(10%, rgba(255, 255, 255, 0.4)), color-stop(50%, rgba(255, 255, 255, 0.4)), color-stop(90%, rgba(255, 255, 255, 0.4)), color-stop(100%, rgba(0, 0, 0, 1))), url(images/linen.png);
                                                                                            /* Chrome,Safari4+ */
                                                                                            background: -webkit-linear-gradient(top, rgba(0, 0, 0, 1) 0%, rgba(255, 255, 255, 0.4) 10%, rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.4) 90%, rgba(0, 0, 0, 1) 100%), url(images/linen.png);
                                                                                            /* Chrome10+,Safari5.1+ */
                                                                                            background: -o-linear-gradient(top, rgba(0, 0, 0, 1) 0%, rgba(255, 255, 255, 0.4) 10%, rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.4) 90%, rgba(0, 0, 0, 1) 100%), url(images/linen.png);
                                                                                            /* Opera 11.10+ */
                                                                                            background: -ms-linear-gradient(top, rgba(0, 0, 0, 1) 0%, rgba(255, 255, 255, 0.4) 10%, rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.4) 90%, rgba(0, 0, 0, 1) 100%), url(images/linen.png);
                                                                                            /* IE10+ */
                                                                                            background: linear-gradient(top, rgba(0, 0, 0, 1) 0%, rgba(255, 255, 255, 0.4) 10%, rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.4) 90%, rgba(0, 0, 0, 1) 100%), url(images/linen.png);
                                                                                            /* W3C */
                                                                                        ...
                                                                                        #fullscreenBtn {
                                                                                            ...
                                                                                            background: rgb(171, 183, 188);
                                                                                            /* Old browsers */
                                                                                            background: -moz-linear-gradient(left, rgba(171, 183, 188, 1) 0%, rgba(232, 233, 234, 1) 100%);
                                                                                            /* FF3.6+ */
                                                                                            background: -webkit-gradient(linear, left top, right top, color-stop(0%, rgba(171, 183, 188, 1)), color-stop(100%, rgba(232, 233, 234, 1)));
                                                                                            /* Chrome,Safari4+ */
                                                                                            background: -webkit-linear-gradient(left, rgba(171, 183, 188, 1) 0%, rgba(232, 233, 234, 1) 100%);
                                                                                            /* Chrome10+,Safari5.1+ */
                                                                                            background: -o-linear-gradient(left, rgba(171, 183, 188, 1) 0%, rgba(232, 233, 234, 1) 100%);
                                                                                            /* Opera 11.10+ */
                                                                                            background: -ms-linear-gradient(left, rgba(171, 183, 188, 1) 0%, rgba(232, 233, 234, 1) 100%);
                                                                                            /* IE10+ */
                                                                                            background: linear-gradient(left, rgba(171, 183, 188, 1) 0%, rgba(232, 233, 234, 1) 100%);
                                                                                            /* W3C */
                                                                                            filter: progid: DXImageTransform.Microsoft.gradient( startColorstr='#abb7bc', endColorstr='#e8e9ea', GradientType=1);
                                                                                            /* IE6-9 */
                                                                                        ...
                                                                                        #fullscreenBtn:hover {
                                                                                            ...
                                                                                            /* Old browsers */
                                                                                            background: -moz-linear-gradient(left, rgba(200, 215, 220, 1) 0%, rgba(227, 234, 237, 1) 63%, rgba(242, 245, 246, 1) 100%);
                                                                                            /* FF3.6+ */
                                                                                            background: -webkit-gradient(linear, left top, right top, color-stop(0%, rgba(200, 215, 220, 1)), color-stop(63%, rgba(227, 234, 237, 1)), color-stop(100%, rgba(242, 245, 246, 1)));
                                                                                            /* Chrome,Safari4+ */
                                                                                            background: -webkit-linear-gradient(left, rgba(200, 215, 220, 1) 0%, rgba(227, 234, 237, 1) 63%, rgba(242, 245, 246, 1) 100%);
                                                                                            /* Chrome10+,Safari5.1+ */
                                                                                            background: -o-linear-gradient(left, rgba(200, 215, 220, 1) 0%, rgba(227, 234, 237, 1) 63%, rgba(242, 245, 246, 1) 100%);
                                                                                            /* Opera 11.10+ */
                                                                                            background: -ms-linear-gradient(left, rgba(200, 215, 220, 1) 0%, rgba(227, 234, 237, 1) 63%, rgba(242, 245, 246, 1) 100%);
                                                                                            /* IE10+ */
                                                                                            background: linear-gradient(left, rgba(200, 215, 220, 1) 0%, rgba(227, 234, 237, 1) 63%, rgba(242, 245, 246, 1) 100%);
                                                                                            /* W3C */
                                                                                        ...
                                                                                        #annotationInstructions {
                                                                                            ...
                                                                                            background: -moz-linear-gradient(top, rgba(222, 239, 255, 0.5) 0%, rgba(152, 190, 222, 1) 100%);
                                                                                            /* FF3.6+ */
                                                                                            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(222, 239, 255, 0.5)), color-stop(100%, rgba(152, 190, 222, 1)));
                                                                                            /* Chrome,Safari4+ */
                                                                                            background: -webkit-linear-gradient(top, rgba(222, 239, 255, 0.5) 0%, rgba(152, 190, 222, 1) 100%);
                                                                                            /* Chrome10+,Safari5.1+ */
                                                                                            background: -o-linear-gradient(top, rgba(222, 239, 255, 0.5) 0%, rgba(152, 190, 222, 1) 100%);
                                                                                            /* Opera 11.10+ */
                                                                                            background: -ms-linear-gradient(top, rgba(222, 239, 255, 0.5) 0%, rgba(152, 190, 222, 1) 100%);
                                                                                            /* IE10+ */
                                                                                            background: linear-gradient(top, rgba(222, 239, 255, 0.5) 0%, rgba(152, 190, 222, 1) 100%);
                                                                                            /* W3C */
                                                                                            filter: progid: DXImageTransform.Microsoft.gradient( startColorstr='#80deefff', endColorstr='#bf98bede', GradientType=0);
                                                                                            /* IE6-9 */
                                                                                        }
                                                                                        ...
                                                                                        #lineInfo div,
                                                                                        #annotationInstructions span {
                                                                                            color: #394753;
                                                                                            text-shadow: 0 1px 0 #ccdfef;
                                                                                        }
            ...
            .lineNav a {top:5px; text-decoration: none;}*/
                                                                                        ...
                                                                                        .addNotes.shrink:hover,
                                                                                        .nextLine.shrink:hover {
                                                                                        ...
                                                                                        /*TODO Hidden for now, can remove later.*/
                                                                                        ...
                                                                                        /*shift from under the main window*/
                                                                                        /* i-frame control */
                                                                                        ...
                                                                                        #vulgateDiv iframe,
                                                                                        #latinSplit iframe {
                                                                                            background: url('images/linen.png') white scroll repeat;
                                                                                            position: relative;
                                                                                        }
                                                                                        ...
                                                                                        .previewLine:nth-child(even) {
                                                                                            background-color: whitesmoke;
                                                                                        }
                                                                                        
                                                                                        .previewLine:nth-child(odd) {
                                                                                        ...
                                                                                        .parsing:nth-child(even) {
                                                                                            background-color: goldenrod;
                                                                                        }
                                                                                        
                                                                                        .parsing:nth-child(odd) {
                                                                                            background-color: lightgoldenrodyellow;
                                                                                        }
                                                                                        
                                                                                        .deletable {
                                                                                            background-color: red !important;
                                                                                            cursor: url("css/custom-theme/images/deleteDiv.png"), url("css/custom-theme/images/deleteDiv.cur"), auto !important;
                                                                                        }
                                                                                        ...
                                                                                        #parseOptions>span,
                                                                                        #linebreakOptions>span,
                                                                                        #columnOptions>span,
                                                                                        #allColumnOptions>span,
                                                                                        #destroyPage,
                                                                                        #reparseColumn {
                                                                                            width: 100%;
                                                                                            height: 38px;
                                                                                        ...
                                                                                        .parsingColumn {
                                                                                            background-image: url('css/custom-theme/images/ui-bg_layered-circles_50_618797_13x13.png');
                                                                                        ...
                                                                                        .parsingColumnSelected {
                                                                                            background-image: url('css/custom-theme/images/ui-bg_layered-circles_50_ffc6b9_13x13.png') !important;
                                                                                            border-color: red !important;
                                                                                            opacity: .5 !important;
                                                                                            cursor: url("css/custom-theme/images/deleteDiv.png"), url("css/custom-theme/images/deleteDiv.cur"), auto !important;
                                                                                        }
                                                                                        /* Visual selection for deleting columns */
                                                                                        ...
                                                                                        /*fixme should not have to overwrite*/
                                                                                        ...
                                                                                        #linebreakText {
                                                                                            ...
                                                                                            height: 40%;
                                                                                            overflow: auto;
                                                                                            background: white fixed repeat;
                                                                                            border: 2px inset #FFDB7F;
                                                                                            margin-bottom: 4px;
                                                                                            position: relative;
                                                                                        }
                                                                                        ...
                                                                                        #createColumnInst .buttons {
                                                                                            max-width: 246px;
                                                                                            margin: 0 auto;
                                                                                        }
                                                                                        
                                                                                        #createColumnInst .buttons button {
                                                                                            min-width: 120px;
                                                                                        }
                                                                                        ...
                                                                                        #zoomDiv {
                                                                                            display: none;
                                                                                            border-radius: 50%;
                                                                                            box-shadow: 5px 5px 15px 3px black, 15px 15px 100px rgba(230, 255, 255, .8) inset, -15px -15px 100px rgba(0, 0, 15, .4) inset;
                                                                                            width: 300;
                                                                                            height: 300;
                                                                                        ...
                                                                                        .historyEntry:hover {
                                                                                            box-shadow: rgba(166, 65, 41, 0.7) 0 0 10px, rgba(166, 65, 41, 0.7) 0 0 10px inset;
                                                                                        }
                                                                                        ...
                                                                                        #helpPanels {
                                                                                            ...
                                                                                            /* IE10+ */
                                                                                            background: radial-gradient(center, ellipse cover, rgba(255, 255, 255, 1) 0%, rgba(204, 204, 204, 1) 100%);
                                                                                            /* W3C */
                                                                                        ...
                                                                                        .helpContents:hover {
                                                                                            box-shadow: 0 0 4px orangered inset;
                                                                                        }
                                                                                        
                                                                                        .helpActive {
                                                                                            box-shadow: 0 0 6px 2px orangered inset !important;
                                                                                        }
                                                                                        ...
                                                                                        .helpPanel {
                                                                                            ...
                                                                                            /* IE10+ */
                                                                                            background: linear-gradient(left, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 50%, rgba(0, 0, 0, 0) 100%);
                                                                                            /* W3C */
                                                                                        ...
                                                                                        .showMe:hover {
                                                                                            color: rgb(255, 36, 0);
                                                                                            border: solid 1px rgba(255, 36, 0, .7);
                                                                                        ...
                                                                                        .helpDetail {
                                                                                            ...
                                                                                            top: 16px;
                                                                                            max-width: 350px;
                                                                                            border: solid 1px rgba(0, 100, 0, .7);
                                                                                            box-shadow: 1px 1px 3px black;
                                                                                            overflow: visible;
                                                                                            z-index: 1;
                                                                                            display: none;
                                                                                            background: whitesmoke url(images/linen.png);
                                                                                            padding: 5px;
                                                                                            text-align: center;
                                                                                        ...
                                                                                        .glossary {
                                                                                            position: relative;
                                                                                            border: dotted 1px transparent;
                                                                                            border-bottom: dotted 1px rgba(0, 100, 0, .7);
                                                                                            cursor: help;
                                                                                            display: inline-block;
                                                                                        }
                                                                                        ...
                                                                                        .ui-resizable-resizing {
                                                                                            box-shadow: 0 0 4px 2px goldenrod !important;
                                                                                            border: none !important;
                                                                                        }
            ...
            #annotationInfo h6 {color:white;}*/
                                                                                        ...
                                                                                        .navigation {
                                                                                            ...
                                                                                            /* Old browsers */
                                                                                            background: -moz-linear-gradient(top, rgba(166, 65, 41, 1) 0%, rgba(244, 150, 129, 1) 100%);
                                                                                            /* FF3.6+ */
                                                                                            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(166, 65, 41, 1)), color-stop(100%, rgba(244, 150, 129, 1)));
                                                                                            /* Chrome,Safari4+ */
                                                                                            background: -webkit-linear-gradient(top, rgba(166, 65, 41, 1) 0%, rgba(244, 150, 129, 1) 100%);
                                                                                            /* Chrome10+,Safari5.1+ */
                                                                                            background: -o-linear-gradient(top, rgba(166, 65, 41, 1) 0%, rgba(244, 150, 129, 1) 100%);
                                                                                            /* Opera 11.10+ */
                                                                                            background: -ms-linear-gradient(top, rgba(166, 65, 41, 1) 0%, rgba(244, 150, 129, 1) 100%);
                                                                                            /* IE10+ */
                                                                                            background: linear-gradient(to bottom, rgba(166, 65, 41, 1) 0%, rgba(244, 150, 129, 1) 100%);
                                                                                            /* W3C */
                                                                                            filter: progid: DXImageTransform.Microsoft.gradient( startColorstr='#a64129', endColorstr='#f49681', GradientType=0);
                                                                                            /* IE6-9 */
                                                                                        }
              ...
              background: url(css/custom-theme/images/ui-bg_dots-medium_75_ffebb9_4x4.png) 50% 50% repeat, rgba(166,65,41,.5);*/
                                                                                        ...
                                                                                        /* break out of clearfix */
                                                                                        /*            #aLink {clear:left;display:none;}  DEBUG until ready for annotation links */
                                                                                    </style>
                                                                                    <script type="text/javascript">
                                                                                        document.write('<style type="text/css">body {visibility:hidden;}\n#historyViewer,[id^="split"],[id$="Split"] {width:' + Page.width() * .4 + 'px;}</style>');
                                                                                    </script>
            ...
            if (thisMS.isRestricted() && !isPrivateCollaborator) { 
                ...
                %>
                                                                                        <div id="requestAccess" class="ui-widget ui-corner-all ui-widget-content">
                                                                                            ...
                                                                                            <div class="ui-state-error-text" style="text-align: center;"><span style="display: inline-block;" class="ui-icon ui-icon-alert"></span>
                                                                                                <%out.print(thisUser.getFname());%>, you do not have permission to view this manuscript!</div>
                                                                                            <br />
                    ...
                    %>
                                                                                                    <p>Request access for
                                                                                                        <%out.print(thisUser.getFname()+" "+thisUser.getLname()+" ("+thisUser.getUname()+") from the TPEN user ("+controllerHint+")");%> who controls access to this document.
            ...
            if (!(thisUser.hasAcceptedIPR(thisFolio.getFolioNumber()))) {
                ...
                %>
                                                                                            <div id="iprAccept" class="ui-widget ui-corner-all ui-widget-content">
                                                                                                ...
                                                                                                <p>Please read and accept the IPR agreement below to access <span class="loud"><%out.print(thisFolio.getCollectionName() + " at "+ thisFolio.getArchive());%></span>.
                                                                                                    You only need to do this once.</p>
                                                                                                <div id="iprAgreement" class="notice">
                                                                                                    <%out.print(thisFolio.getIPRAgreement());%>
                                                                                                </div>
        ...
        %>
                    ...
                    <a id="helpMe" class="wBtn">Help<span class="ui-icon ui-icon-help right"></span></a>
                                                                                                ...
                                                                                                <div id="wrapper" class="ui-corner-all">
                                                                                                    <div id="help">
                                                                                                        ...
                                                                                                        <div id="helpPanels">
                                                                                                            <div class="helpPanel" title="Page Navigation">
                                                                                                                ...
                                                                                                                <ul class="helpColumn">
                                                                                                                    <li>Move through the page with the <span class="showMe">Previous Line</span> and <span class="showMe">Next Line</span> buttons to move from
                                                                                                                        line to line.</li>
                                                                                                                    <li>The <span class="showMe">Line Indicator</span> identifies the current column and line based on the T&#8209;PEN <span ref="glossParsing"
                                                                                                                            class="glossary">image parsing</span>.</li>
                                                                                                            ...
                                                                                                            <div class="helpPanel" title="Transcription Tools">
                                                                                                                ...
                                                                                                                <dl class="helpColumn">
                                                                                                                    ...
                                                                                                                    <dd>Expand the <span class="showMe">Characters</span> or <span class="showMe">XML Tags</span> list to reveal buttons to insert your custom
                                                                                                                        tags or <span ref="glossSpecialCharacters" class="glossary">special characters</span> into the <span ref="glossTranscriptionArea" class="glossary">transcription area</span>.</dd>
                                                                                                                    <dt class="showMe">View Full Page</dt>
                                                                                                                    <dd>Show the whole page image. Mouseover the image to highlight individual lines. Click to navigate directly to that line. Use the available
                                                                                                                        <span class="showMe">magnify tool</span> to take a closer look.</dd>
                                                                                                                    <dt class="showMe">History</dt>
                                                                                                                    <dd>Lists the previous saved versions of the <span ref="glossParsing" class="glossary">line parsing</span> and <span ref="glossTranscription"
                                                                                                                            class="glossary">transcription text</span>. Mouseover the history entries to reveal options to revert to a previous version.</dd>
                                                                                                                    ...
                                                                                                                    <dd>Reveal the <span ref="glossTranscription" class="glossary">transcription text</span> on the previous, current, and following pages. Make
                                                                                                                        changes to text on other pages within the tool.</dd>
                                                                                                                </dl>
                                                                                                            </div>
                                                                                                            <div class="helpPanel" title="Manuscript Navigation">
                                                                                                                ...
                                                                                                                <ul class="helpColumn">
                                                                                                                    ...
                                                                                                                    <li>The <span class="showMe">Previous Page</span> and <span class="showMe">Next Page</span> buttons step through the project one page at a
                                                                                                                        time.</li>
                                                                                                                </ul>
                                                                                                            </div>
                                                                                                            <div class="helpPanel" title="Keyboard Shortcuts">
                                                                                                                ...
                                                                                                                <dl class="helpColumn">
                                                                                                                    ...
                                                                                                                    <dt>ALT:</dt>
                                                                                                                    <dd>Hold to adjust the interface. Slide the main workspace up and down to see more of the manuscript;<br/>move the manuscript image freely
                                                                                                                        behind the main workspace; or<br/>resize the bookmark bounding box to precisely bound an odd or skewed line.</dd>
                                                                                                                    <dt>CTRL:</dt>
                                                                                                                    <dd>Hold to get a better view of the important parts of your manuscript. The bookmark bounding box, location flag, and bug report form will
                                                                                                                        all fade out and let you see the manuscript or tool behind it.</dd>
                                                                                                                    <dt>F1:</dt>
                                                                                                            ...
                                                                                                            <div class="helpPanel" title="Glossary">
                                                                                                                ...
                                                                                                                <dl class="helpColumn">
                                                                                                                    ...
                                                                                                                    <dd>Entity intended to represent the human connected to a T&#8209;PEN account. Users login with the e-mail address associated with the T&#8209;PEN
                                                                                                                        account and are displayed to others by a first initial and last name.</dd>
                                                                                                                    <dt id="glossTranscription">Transcription</dt>
                                                                                                                    <dd>Usually referring to the textual data associated with an image region. Transcription metadata include specific location, date of creation,
                                                                                                                        and associated image data.</dd>
                                                                                                                    ...
                                                                                                                    <dd>Describes the automatic or manual process of logically splitting a page into rectangular regions to designate individual lines for transcribing.
                                                                                                                        Changes to parsing are saved in the history of a transcription.</dd>
                                                                                                                    ...
                                                                                                                    <dd>Custom-coded buttons that automatically enter a unicode character (typically one not included on the user's keyboard) into the transcription
                                                                                                                        area.</dd>
                                                                                                                    <dt id="glossButtons">Buttons</dt>
                                                                                                                    <dd>Typically refers to XML Tag objects customized on the Button Management page. May also refer to Special Character objects in the same location.
                                                                                                                        "Buttons" may also used in the generic sense to refer to a graphically distinct, clickable region which invokes an expected action.</dd>
                                                                                                                </dl>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div id="helpContents">
                                                                                                    ...
                                                                                                    <div id="imgTop">
                                                                                                        <div class="ui-corner-all" id="bookmark">
                                                                                                            <div id="bookmarkText"></div>
                                                                                                        </div>
                                                                                                        ...
                                                                                                        <div id="parsingSplit" class="ui-widget">
                                                                                                            ...
                                                                                                            <div id="parsingDiv" class="ui-corner-all ui-widget-content">
                                                                                                                <div id="parseOptions">
                                                                                                                    ...
                                                                                                                    <span id="backToTranscribing" class="tpenButton" onclick="$('#fullscreenBtn').click();"><span class="ui-icon ui-icon-arrowreturn-1-w left"></span>Return
                                                                                                                    to Transcribing</span>
                                                                                                                    <span id="ctrlColumns" class="tpenButton" title="Make adjustments at the column level"><span class='ui-icon ui-icon-carat-1-e left'></span>Column
                                                                                                                    Controls</span>
                                                                                                                        ...
                                                                                                                        <div class="accordion">
                                                                                                                            ...
                                                                                                                            <div id="createColumnInst">
                                                                                                                                ...
                                                                                                                                <p class="small"><span class="inline ui-icon ui-icon-check"></span>This method does not destroy any <acronym title="Text, markup, and notes saved for lines within this column will remain attached.">transcription information</acronym>.<br
                                                                                                                                    />
                                                                                                                                    <span class="ui-state-error-text"><span class="inline ui-icon ui-icon-alert"></span>New column dimensions will overwrite
                                                                                                                                    some <acronym title="Custom heights will be retained, but the width will be uniform.">custom line settings</acronym>.</span>
                                                                                                                                </p>
                                                                                                                            </div>
                                                                                                                            ...
                                                                                                                            <div id="destroyColumnInst">
                                                                                                                                ...
                                                                                                                                <span id="destroyPage" class="tpenButton ui-state-error" title="Destroy all columns on this page"><span class="left ui-icon ui-icon-circle-close"></span>Destroy
                                                                                                                                All Lines</span>
                                                                                                                                <p class="small"><span class="inline ui-icon ui-icon-check"></span>You will be warned before destroying any <acronym title="Text, markup, and notes saved for lines within this column">transcription information</acronym>.<br
                                                                                                                                    />
                                                                                                                                    <span class="ui-state-error-text"><span class="inline ui-icon ui-icon-alert"></span>This is a destructive process and cannot
                                                                                                                                    be undone.</span>
                                                                                                                                </p>
                                                                                                                            </div>
                                    ...
                                    <p class="small"><span class="ui-state-error-text"><span class="inline ui-icon ui-icon-alert"></span>This is a destructive process and cannot be undone.</span><br />
                                        ...
                                        <span class="inline ui-icon ui-icon-check"></span>You will be warned before destroying any <acronym title="Text, markup, and notes saved for lines on this page.">transcription information</acronym>.
                                                                                                                            ...
                                                                                                                            <div id="reparseColumnsInst">
                                                                                                                                ...
                                                                                                                                <span id="reparseColumn" class="tpenButton ui-state-error" title="Reparse all columns on this page"><span class="left ui-icon ui-icon-refresh"></span>Submit
                                                                                                                                for Reparsing</span>
                                                                                                                    ...
                                                                                                                    <span id="ctrlLines" class="tpenButton" title="Make adjustments at the line level"><span class='ui-icon ui-icon-carat-1-e left'></span>Line
                                                                                                                    Controls</span>
                                                                                                                        ...
                                                                                                                        <div class="accordion">
                                                                                                                            ...
                                                                                                                            <div id="addLinesInst">
                                                                                                                                ...
                                                                                                                                <p class="small"><span class="inline ui-icon ui-icon-check"></span>This method retains all your <acronym title="Text, markup, and notes saved for lines within this column will remain attached.">transcription information</acronym>.<br
                                                                                                                                    ...
                                                                                                                                    <span><span class="inline ui-icon ui-icon-info"></span>To add a line outside of the defined columns, <span class="ui-button loud"
                                                                                                                                        onclick="$('#ctrlColumns').click();$('#createColumn').click();" title="Click to use the Create a Column option">Create a Column</span>.</span>
                                                                                                                                </p>
                                                                                                                                <div align="center">
                                                                                                                            ...
                                                                                                                            <div id="removeLinesInst">
                                                                                                                                ...
                                                                                                                                <p class="small"><span class="inline ui-icon ui-icon-info"></span>This method combines your <acronym title="Text, markup, and notes saved for lines within this column will remain attached.">transcription information</acronym>                                                                                                                                    into the new line.<br />
                                                                                                                                    <span class="ui-state-error-text"><span class="inline ui-icon ui-icon-alert"></span>Deleting lines also removes any associated
                                                                                                                                    <acronym title="text, markup, and notes">transcription information</acronym>.</span> <br />
                                                                                                                                    <span><span class="inline ui-icon ui-icon-info"></span>To add a line, use the <span class="ui-button loud" onclick="$('#addLines').click();"
                                                                                                                                        title="Click to use the Add Lines option">Add Lines</span> option.</span>
                                                                                                                                </p>
                                                                                                                            </div>
                                                                                                                            ...
                                                                                                                            <div id="adjustLinesInst">
                                                                                                                                ...
                                                                                                                                <p class="small"><span class="inline ui-icon ui-icon-check"></span>This method retains all your <acronym title="Text, markup, and notes saved for each line will remain attached.">transcription information</acronym>.<br
                                                                                                                                    ...
                                                                                                                                    <span><span class="inline ui-icon ui-icon-info"></span>Make precise, individual changes in the <acronym title="Hold ALT while transcribing to resize the line width and height precisely.">transcription view</acronym>.</span>
                                                                                                                                </p>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div id="confirmParsingInst">
                                                                                                                        ...
                                                                                                                        <div>
                                                                                                                            <p class="">Return to transcribing after confirming that image parsing is correct. If the automatic parsing is not accurate, use the options
                                                                                                                                above to make corrections.</p>
                                                                                                                            <p class="small"><span class="inline ui-icon ui-icon-check"></span>This will not be required once you have saved transcription data on this page.<br
                                                                                                                                />
                                                                                                                                <span class="ui-state-error-text"><span class="inline ui-icon ui-icon-alert"></span>Changes made here affect all group members
...
%>
                                                                                                                                                ...
                                                                                                                                                <div id="split<%out.print(i);%>">
                                                                                                                                                    <div class="toolLinks">
                                                                                                                                                        ...
                                                                                                                                                        <a href="<%out.print(frameLink);%>" target="_blank" title="Open this tool in a new tab" class="frameTab">
                                                                                                                                                            <%out.print(frameName);%><span class="ui-icon ui-icon-extlink left"></span></a>
                                                                                                                                                    </div>
